            ...
            <div className="items flex ">
              ...
              <div className="ex border-8 bg-gray-200 rounded-3xl shadow-lg">
                ...
                <p className=" bg-gray-200 text-2xl break-words  ">
                  This is the premium plan that allows you to store up to <span className="numberHighlight">10</span> boxes without any extra monthly cost. Ideal for families or
                  couples.
                </p>
          ...
          <div className="flex flex-col  ">
            <div className="items flex  ">
              ...
              <div className="ex border-8 bg-gray-200 rounded-3xl shadow-lg ">
                ...
                <p className=" bg-gray-200 text-2xl break-words ">
                  This is the basic plan that allows you to store up to <span className="numberHighlight">5</span> boxes
