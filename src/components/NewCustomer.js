...
function NewCustomer({ setMode }) {
  ...
  const [providerEmergencyContactPhone, setProviderEmergencyContactPhone]=useState("");
...
const handleProviderSubmit = (e) =>{
  ...
  if (registrationDone === false) {
    return <div className="containerNewRegistration">
      ...
      <div className="newProvider">REGISTER AS A STORAGE PROVIDER
      <form>
          <br></br>
            <label>
            First Name:
            <input type="text" name="firstname" placeholder="Your first name" value={providerFirstName} onChange={createProviderFirstName}/><br></br>
            Last Name:
            <input type="text" name="lastname" placeholder="Your last name" value={providerLastName} onChange={createProviderLastName}/><br></br>
            Password:
            <input type="password" name="password" placeholder="Your created password" value={providerPassword} onChange={createProviderPassword}/><br></br>
            Address:
            <input type="text" name="address" placeholder="Your address" value={providerAddress} onChange={createProviderAddress}/><br></br>
            Email:
            <input type="text" name="email" placeholder="Your email" value={providerEmail} onChange={createProviderEmail}/><br></br>
            Banking Reference:
            <input type="text" name="bankreference" placeholder="Your banking reference" value={providerBankReference} onChange={createProviderBankReference}/><br></br>
            Emergency Contact Person:
            <input type="text" name="emergencycontact" placeholder="Emergency contact" value={providerEmergencyContact} onChange={createProviderEmergencyContact}/><br></br>
            Emergency Contact Phone:
            <input type="text" name="emergencycontactphone" placeholder="Emergency contact phone" value={providerEmergencyContactPhone} onChange={createProviderEmergencyContactPhone}/><br></br>
            Storage place picture:
            <input type="file" name="file" onChange={pictureStorageHandler}/><br></br>
          </label>
          <br></br>
      ...
      if (registrationDone === true) {
        return <div className="registrationDone">
      <div>THANK YOU FOR YOUR REGISTRATION 
        <br></br>
        <button onClick={()=>setMode("homePage")}>Back to homepage</button>
      </div>
      </div>
